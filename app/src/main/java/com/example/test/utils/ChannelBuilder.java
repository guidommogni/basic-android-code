...
public class ChannelBuilder {
    ...
    public static ManagedChannel build(String host, int port, @Nullable String serverHostOverride, boolean useTls,
        ...
        if (useTls) {
            try {
                ...
                ((OkHttpChannelBuilder) channelBuilder).hostnameVerifier(allHostsValid);
            } catch (Exception e) {
    ...
    private static TrustManager[] getTrustManagers(InputStream testCa) throws Exception {
        ...
        final X509Certificate cert = (X509Certificate) cf.generateCertificate(testCa);
